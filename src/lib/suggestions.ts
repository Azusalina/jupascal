...
const FACULTY_CODE_MAP: Record<string, string> = {
  ba: "business", business: "business", sci: "science", science: "science",
  soc: "social sciences", ssc: "social sciences", computing: "computing and data science",
};
...
const DISCIPLINE_WORDS = new Set([
  ...
  "technology", "social", "psychology", "sociology", "policy", "humanities",
  "biology", "chemistry", "physics", "mathematics", "statistics", "actuarial",
]);
